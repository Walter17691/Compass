    ...
    <div style={{width:"100%",maxWidth:CONTENT_MAX_WIDTH,margin:"0 auto",padding:"40px 28px"}}>
      ...
      <div style={{display:"flex",gap:32,alignItems:"flex-start"}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          ...
          {active==="team-access"&&<TeamAccessSection isHR={isHR} currentUserRole={team.currentUserRole} org={org.org} locations={org.locations} teamMembers={team.teamMembers} editingMember={team.editingMember} setEditingMember={team.setEditingMember} removeMember={team.removeMember} updateMemberRole={team.updateMemberRole} updateCaseAccessLevel={team.updateCaseAccessLevel} assignLocations={team.assignLocations} inviteForm={team.inviteForm} setInviteForm={team.setInviteForm} inviting={team.inviting} inviteMember={team.inviteMember} pendingInvites={team.pendingInvites} revokeInvite={team.revokeInvite} resendInvite={team.resendInvite} resendingInviteId={team.resendingInviteId}/>}
