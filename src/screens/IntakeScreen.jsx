      ...
      <div style={{maxWidth:620,margin:"0 auto",padding:"40px 24px"}}>
        ...
        <div style={{background:"#FFFFFF",border:"1px solid #E8E0D0",borderRadius:12,padding:"24px",marginBottom:16,boxShadow:"0 1px 3px rgba(26,21,53,0.04)"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
            ...
            <div>
              ...
              <input id="intake-manager" value={intake.manager} onChange={e=>setIntake(p=>({...p,manager:e.target.value}))}
            ...
            <div>
              <label htmlFor="intake-date-received" style={{display:"block",fontSize:13,fontWeight:500,color:"#1A1535",marginBottom:6}}>Date received</label>
              <input id="intake-date-received" type="date" value={intake.dateReceived} onChange={e=>setIntake(p=>({...p,dateReceived:e.target.value}))}
            ...
            <div>
              <label htmlFor="intake-referred-by" style={{display:"block",fontSize:13,fontWeight:500,color:"#1A1535",marginBottom:6}}>Referred by</label>
              <input id="intake-referred-by" value={intake.referredBy} onChange={e=>setIntake(p=>({...p,referredBy:e.target.value}))}
        ...
        <div style={{background:"#FFFFFF",border:"1px solid #E8E0D0",borderRadius:12,padding:"24px",marginBottom:16,boxShadow:"0 1px 3px rgba(26,21,53,0.04)"}}>
          ...
          <div style={{marginBottom:14}}>
            <label htmlFor="intake-description" style={{display:"block",fontSize:13,fontWeight:500,color:"#1A1535",marginBottom:6}}>Brief summary of the issue</label>
            <textarea id="intake-description" value={intake.description} onChange={e=>setIntake(p=>({...p,description:e.target.value}))}
