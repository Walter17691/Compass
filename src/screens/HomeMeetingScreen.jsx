        ...
        <div style={{width:"100%",maxWidth:480}}>
          ...
          {(() => {
            ...
            const commit = () => {
              ...
              setTranscript([]);setPrepNotes("");setPrepQuestions([]);setMeetingEvidenceSuggestions([]);setMeetingActionSuggestions([]);setReviewOutput("");setReviewOutputOriginal("");setMeetingSummary("");setLetterOutput("");setRiskScore(null);setLiveChatHistory([]);setParticipants(meetingSetup.participants||[]);
            };
            return (
              <div style={{display:"flex",gap:8}}>
                {!isDev&&(
