...
const BarRow = ({ label, value, max, color = COLOR.inkQuiet }) => (
  <div style={{marginBottom:8}}>
    <div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}>
      ...
      <span style={{fontSize:12,color:COLOR.inkFaint}}>{value} case{value===1?"":"s"}</span>
    </div>
...
export function PolicyEffectivenessPanel({ caseSignals, hrReviewRequests }) {
  ...
  return (
    <div>
      <div style={{...TYPE.sectionHeading,color:COLOR.inkFaint,marginBottom:10}}>Policy effectiveness</div>
      ...
      {clarificationCount > 0 && (
        <div style={{marginTop:12,fontSize:12,color:COLOR.inkFaint}}>
