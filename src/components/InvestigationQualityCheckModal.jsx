...
// advisory only, every path out — including × / Escape — lets submission
// proceed. Retitled and re-worded for computeInvestigationQualityGaps'
// own gaps (unexplored allegations, witnesses named but not interviewed,
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="investigation-quality-title" ref={containerRef} tabIndex={-1}
      ...
      <div style={{background:"#FFFFFF",border:"1px solid #E8E0D0",borderRadius:16,padding:28,width:"100%",maxWidth:520,maxHeight:"80vh",overflowY:"auto"}}>
        ...
        <h3 id="investigation-quality-title" style={{fontFamily:"DM Serif Display,Georgia,serif",fontSize:17,color:"#1A1535",marginBottom:10,fontWeight:400}}>
          A few things worth checking before this investigation is submitted
        </h3>
        ...
        <div style={{display:"flex",gap:8,justifyContent:"flex-end",flexWrap:"wrap"}}>
          <Btn variant="ghost" onClick={onGoBack}>Go back</Btn>
