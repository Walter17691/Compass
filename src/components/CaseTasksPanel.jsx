...
export function CaseTasksPanel({ cs, tasks, createCaseTask, toggleCaseTaskDone, deleteCaseTask, fmtDate }) {
        ...
        {sorted.map(t => (
          <div key={t.id} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 0",borderBottom:"1px solid #F5F1EA"}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              <div style={{fontSize:13,color:"#1A1535",textDecoration:t.status==="done"?"line-through":"none",opacity:t.status==="done"?0.6:1}}>{t.name}</div>
