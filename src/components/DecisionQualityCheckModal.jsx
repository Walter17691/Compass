...
// including × / Escape, lets the outcome proceed), just retitled for the
// decision-quality gaps computeDecisionQualityGaps finds (unreviewed
// allegations, thin reasoning, missing evidence/policy links, unresolved
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="decision-quality-title" ref={containerRef} tabIndex={-1}
      ...
      <div style={{background:"#FFFFFF",border:"1px solid #E8E0D0",borderRadius:16,padding:28,width:"100%",maxWidth:520,maxHeight:"80vh",overflowY:"auto"}}>
        ...
        <h3 id="decision-quality-title" style={{fontFamily:"DM Serif Display,Georgia,serif",fontSize:17,color:"#1A1535",marginBottom:10,fontWeight:400}}>
          A few things worth checking before this outcome goes out
        </h3>
