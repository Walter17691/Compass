...
export function OutcomeTab({ cs, stage, fmtDate, setShowOutcomeModal }) {
  const reached = stage==="disciplinary"||stage==="outcome"||stage==="appeal"||stage==="closed"||!!cs.outcome;

  if (!reached) {
    return (
      <div style={{textAlign:"center",padding:"40px",background:"#FFFFFF",borderRadius:12,border:"1px solid #E8E0D0"}}>
        <div style={{fontSize:14,color:"#9B9098"}}>No outcome yet — this case hasn't reached a disciplinary hearing.</div>
      </div>
    );
  }
