...
");
    ...
    a.href=url; a.download=`${org?.name||"Compass"}_Cases_${new Date().toLocaleDateString("en-GB").replace(/\//g,"-")}.csv`; a.click();
...
/g," ")+"...",9,196,189,175);
    ...
    doc.save(`${org?.name||"Compass"}_Cases_${new Date().toLocaleDateString("en-GB").replace(/\//g,"-")}.pdf`);
  };
