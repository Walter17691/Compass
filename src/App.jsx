...
Include: date, greeting, what was discussed, agreed outcomes, next steps, signature block.`,
  ...
  const LETTER_TEMPLATES = {
    outcome: (emp, chair, date, meetingType) => [
      ...
      "Dear " + emp.split(" ")[0] + ",",
      "",
      "RE: OUTCOME OF " + (meetingType || "DISCIPLINARY HEARING").toUpperCase(),
      "",
      "I am writing to confirm the outcome of the " + (meetingType || "disciplinary hearing") + " held on " + date + ".",
      "",
      "DECISION",
      ...
      "",
      "DURATION",
      "[If warning: This warning will remain on your file for [X months] from the date of this letter.]",
      "",
      "RIGHT OF APPEAL",
      "You have the right to appeal against this decision. If you wish to appeal, please write to [Name and Job Title] within 5 working days of receiving this letter, setting out your grounds of appeal.",
      "",
      "Yours sincerely,",
      "",
      chair,
    ...
    invite: (emp, chair, date, meetingType) => [
      ...
      "Dear " + emp.split(" ")[0] + ",",
      "",
      "RE: INVITATION TO " + (meetingType || "HEARING").toUpperCase(),
      "",
      ...
      "",
      "PURPOSE",
      "[Insert purpose — e.g. To discuss allegations of misconduct / To discuss your grievance dated [date]]",
      "",
      "ALLEGATIONS / ISSUES TO BE DISCUSSED",
      "[Set out clearly the specific allegations or issues to be discussed]",
      "",
      "EVIDENCE",
      "Copies of the evidence to be referred to at the meeting are enclosed / available on request.",
      "",
      "RIGHT TO BE ACCOMPANIED",
      ...
      "",
      "If you are unable to attend on the date proposed, please contact [HR contact] as soon as possible so that an alternative date can be arranged.",
      "",
      "Yours sincerely,",
      "",
      chair,
    ...
    appeal: (emp, chair, date, meetingType) => [
      ...
      "",
      "I am writing to confirm the outcome of your appeal hearing held on " + date + ".",
      "",
      "ORIGINAL DECISION",
      "[Insert original decision being appealed]",
      "",
      "GROUNDS OF APPEAL",
      "[Summarise the grounds of appeal raised]",
      "",
      "OUTCOME",
      "[Select one:]",
      "[ ] Appeal upheld — original decision overturned",
      "[ ] Appeal partially upheld — original decision varied to [insert amended sanction]",
      "[ ] Appeal not upheld — original decision confirmed",
      "",
      "REASONS",
      "[Insert reasons for the appeal outcome]",
      "",
      "FINAL DECISION",
    ...
    redundancy_atrisk: (emp, chair, date) => [
      ...
      "",
      "I am writing to inform you that your role of [Job Title] has been identified as potentially at risk of redundancy.",
      "",
      "REASON",
      "[Insert business reason — e.g. restructure / reduction in workload / closure of department]",
      "",
      "CONSULTATION",
      "No final decision has been made. We are committed to a period of meaningful consultation with you before any decision is reached. A consultation meeting was held on " + date + " chaired by " + chair + ".",
      "",
      "ALTERNATIVES TO REDUNDANCY",
      "We will actively explore all reasonable alternatives to redundancy, including suitable alternative vacancies, reduced hours, and voluntary redundancy.",
      "",
      "RIGHT TO BE ACCOMPANIED",
      "You have the right to be accompanied at any consultation meeting by a trade union representative or a work colleague.",
      "",
      "A further consultation meeting will be arranged in due course. If you have any questions please contact " + chair + ".",
      "",
      "Yours sincerely,",
      "",
      chair,
    ...
    redundancy_outcome: (emp, chair, date) => [
      ...
      "",
      "I am writing to confirm that, following the completion of our consultation process, your role of [Job Title] has been made redundant.",
      "",
      "TERMINATION DATE",
      "Your last working day will be [insert last working day].",
      "",
      "NOTICE",
      "Your notice period of [X weeks] runs from " + date + " to [insert end date]. You will [work your notice period in full / receive a payment in lieu of notice].",
      "",
      "REDUNDANCY PAY",
      ...
      "",
      "RIGHT OF APPEAL",
      "You have the right to appeal this decision within 5 working days of receiving this letter. To appeal, please write to [HR contact name and job title] setting out your grounds of appeal.",
      "",
      "Yours sincerely,",
      "",
      chair,
