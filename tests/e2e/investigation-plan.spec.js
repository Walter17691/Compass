...
test('generating an investigation plan adds case-specific tasks, tagged and visible in the Tasks tab', async ({ page }) => {
  ...
  // The case workspace's own "Tasks" section shares its label with the
  // top-nav "Tasks" destination visible on the same page — openCaseSection
  // scopes to the case tab bar's own "More" popover (E2E Navigation
  // Alignment pass), the same disambiguation tasks.spec.js/
  // case-changes.spec.js use.
