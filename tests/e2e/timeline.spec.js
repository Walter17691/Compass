...
// allegation added to it, and it can be closed back to the normal case
// view.
test('the case timeline shows case-opened and allegation events, and can be toggled off', async ({ page }) => {
